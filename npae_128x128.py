...
# read in dataset
train = np.load('./training_dataset_128x128/train.npy')
val = np.load('./training_dataset_128x128/val.npy')
test = np.load('./training_dataset_128x128/test.npy')
...
# save predict
np.save('./training_dataset_128x128/predict.npy', predict)


# save model
json_string = model.to_json()
with open('./training_dataset_128x128/model.json', 'w') as f:
        f.write(json_string)
# save weights
model.save_weights('./training_dataset_128x128/model_weights.h5')



# save loss for plot
with h5py.File('./training_dataset_128x128/history_loss.hdf5', 'w') as f:
...
plt.savefig('./training_dataset_128x128/loss.png')
plt.close()
...
# plt.savefig('./training_dataset_128x128/accuracy.png')
# plt.close()
