...
# read in dataset
train = np.load('./training_dataset/train.npy')
val = np.load('./training_dataset/val.npy')
test = np.load('./training_dataset/test.npy')
...
# save predict
np.save('./training_dataset/predict.npy', predict)
...
# save loss for plot
with h5py.File('history_loss.hdf5', 'w') as f:
